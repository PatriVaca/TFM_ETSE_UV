...
plot <- plotReducedDim(scegv, dimred="PCA", colour_by="Patient_ID") +
  scale_color_viridis_d(name="Paciente")
...
plot <- plotReducedDim(scegv_dw, dimred="PCA", colour_by="Patient_ID") +
...
plot <- plotReducedDim(sceP, dimred="PCA", colour_by="Patient_ID") +
  scale_color_viridis_d("Paciente")
