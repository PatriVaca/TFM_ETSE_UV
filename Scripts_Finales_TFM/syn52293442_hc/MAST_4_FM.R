...
for (i in 1:length(cell_types)){
  ...
  # Test hypothesis
  zlmCond_cells_FM <- lrTest(zlmCond, Hypothesis("(Group_sexAD_Female - Group_sexControl_Female) -
                                                 (Group_sexAD_Male - Group_sexControl_Male)"))
  ...
  LFC.sF = LFC.standard(data = sce.dge, results = resultsF, case = "AD_Female", control = "Control_Female")
  ...
  # Calculate LFCs
  LFC.sM = LFC.standard(data = sce.dge, results = resultsM, case = "AD_Male", control = "Control_Male")
  
  LFC.mFM = LFC.MAST(zlm = zlmCond,
                     control = c("Group_sexControl_Female","Group_sexAD_Male"),
                     case =  c("Group_sexControl_Male","Group_sexAD_Female"),
                     results = results_2)
