---
      ...
      output:
        html_document:
          ...
          theme: spacelab
      ---
      ## MA_HC_Oligodendrocitos_M {.tabset .tabset-pills -}
...
```{r, fig.align='center'}
datatable(sig.genes.df[,c(1:5,12,15)], caption='Statistics of 298 significant genes',rownames=FALSE, escape = FALSE, filter = 'top')
```
